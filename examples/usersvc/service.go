...
//go:generate protogo httptest ./service.go Service --mode=server --spec=./httptest.server.yaml
//go:generate protogo httptest ./service.go Service --mode=client --spec=./httptest.client.yaml
